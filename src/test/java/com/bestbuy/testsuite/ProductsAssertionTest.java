...
public class ProductsAssertionTest {
    ...
    //14. Check the multiple ‘Names’ in the ArrayList (Duracell - AA 1.5V CopperTop Batteries (4Pack), Duracell - AA Batteries (8-Pack), Energizer - MAX Batteries AA (4-Pack))
    @Test
    public void test014() {
    ...
    @Test
    public void test015() {
        response.body("data[3]",hasEntry("id", 150115))
